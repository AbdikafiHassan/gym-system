            ...
            <div class="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                <div class="overflow-hidden bg-white rounded-xl">
                    <div class="p-6">
                        ...
                        <p class="mt-6 text-lg font-medium text-gray-900">+252-615008900</p>
                        <p class="mt-1 text-lg font-medium text-gray-900">+252-621239089</p>
                    </div>
                </div>
                ...
                <div class="overflow-hidden bg-white rounded-xl">
                    <div class="p-6">
                        ...
                        <p class="mt-6 text-lg font-medium text-gray-900">ahmed@gmail.com</p>
                        <p class="mt-1 text-lg font-medium text-gray-900">Bocor@youtube.com</p>
                    </div>
                </div>
                ...
                <div class="overflow-hidden bg-white rounded-xl">
                    <div class="p-6">
                        ...
                        <p class="mt-6 text-lg font-medium leading-relaxed text-gray-900">232 Mogadishu Rd. dabka, Maka-All-Mukarma 200, somalia</p>
                    </div>
                </div>
            </div>
